...
const SalesforceLookup = () => {
  ...
  const lookupPrimaryRevenue = (opp) => opp.carr ?? opp.arr ?? opp.grossARR ?? opp.amount;
  ...
  const GongConversationsSection = ({ opportunityId }) => {
    ...
    return (
      <div className="lookup-detail-section">
        ...
        <div
          className={`lookup-gong-conversations ${conversations.length > 4 ? 'lookup-gong-conversations-scrollable' : ''}`}
        >
            ...
            <div className="lookup-detail-section">
              ...
              <div className="lookup-detail-grid">
                ...
                <div className="lookup-detail-item">
                  ...
                  <span className="lookup-detail-value">
                    {opportunity.forecastCategory || 'N/A'}
                  </span>
                </div>
                <div className="lookup-detail-item">
          ...
          {results.length === 0 ? (
            ...
            <>
              ...
              <div className="lookup-single-result">
                <div className="lookup-detail-card">{renderFullDetails(results[0])}</div>
              </div>
            </>
          ) : selectedOpportunity ? (
            <>
              ...
              <div className="lookup-single-result">
                <div className="lookup-detail-card">{renderFullDetails(selectedOpportunity)}</div>
              </div>
            </>
          ) : (
            <>
